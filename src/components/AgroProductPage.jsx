...
function AgroProductPage() {
  return (
    <>
        <section className='product_page'>
                <div className='agro_banner'>
                    <h1 className='text-center'>Agro Peoducts</h1>
                    <nav className="breadcrumb d-flex justify-content-center">
                        <NavLink className="breadcrumb-item" to="/">Home</NavLink>
                        <span className="breadcrumb-item active" aria-current="page">Agro Products</span>
                    </nav>
                </div>
